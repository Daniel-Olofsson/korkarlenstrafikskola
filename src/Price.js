  ...
  return (
    <div className="table-responsive">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <h5 className="card-text ">
                Helgkörning kostar 15% extra per lektion och gäller B, B96, BE,
                C, C1, D, CE
              </h5>
              <h5 className="card-text ">
                Körkarlens trafikskola kan utbilda trafiklärare till buss,
                lastbil och lastbil med släp.
              </h5>
              <h5 className="card-text ">
                Köpta lektioner måste utnyttjas inom sex månader
              </h5>
              <h5 className="card-text ">
                Inskrivning i datorsystemet kostar 500 kr
              </h5>
            </div>
          </div>
        </div>
      ...
      <h1 className="padding-zero">
        <span className="gold">Guld,</span>
        <span className="silver">Silver,</span>
        <span className="bronze">Brons-paketen</span>
      </h1>
      <table className="table table-hover">
        <thead>
